...
export LD_LIBRARY_PATH=/usr/local/python3.9.5/lib:/usr/local/lib/:/usr/lib:${LD_LIBRARY_PATH}
export PYTHONPATH=/usr/local/python3.9.5/lib/python3.9/site-packages:/usr/local/Ascend/tfplugin/latest/python/site-packages:${PYTHONPATH}

export MX_SDK_HOME=/usr/local/Ascend/mxManufacture
